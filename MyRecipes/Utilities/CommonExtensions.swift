...
extension UIApplication {
 static var appVersion: String? {
    ...
    return Bundle.main.object(forInfoDictionaryKey: "CFBundleVersion") as? String // CFBundleVersion
 }
}

extension UIView {
    
    // availabe from swift 4+
    func newRoundCorners(with CACornerMask: CACornerMask, radius: CGFloat) {
...
extension UINavigationItem {
    ...
    /// `leftPartsSupplementBackButton` property. When set to `false`, the back button
    /// is shown if it is still present. (It can be replaced by values in either
    /// the `leftBarButtonItem` or `leftBarButtonParts` properties.) The default value is `false`.
...
extension UIImageView {
    static func fromGif(frame: CGRect, resourceName: String) -> UIImageView? {
        //let files = Bundle.main.paths(forResourcesOfType: "gif", inDirectory: "Resources")
        //let directory = Bundle.main.path(forResource: "iPad", ofType: "gif", inDirectory: "Resources")
...
// MARK: - Extension (Move to common place)
extension UIImage {
